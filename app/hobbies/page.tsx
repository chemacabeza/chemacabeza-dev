                            ...
                            <div>
                                ...
                                <div className="grid grid-cols-1 sm:grid-cols-2 gap-4">
                                    {[
                                        ...
                                        { name: "Character Library", desc: "Extensive collection of 40+ geographically distinct characters", url: "https://github.com/chemacabeza/my-github-projects/tree/master/AI-related#loras" },
                                    ].map(lora => (
