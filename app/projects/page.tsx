...
const githubProjects = [
    ...
    },
    {
        ...
        subtitle: "41 chapters · 9 phases · Scale to Millions",
        description:
            "How do you design YouTube? How does WhatsApp deliver a message in 30 ms? This 41-chapter curriculum, distilled from over 40 professional-grade textbooks (DDIA by Kleppmann, Alex Xu's System Design Interview, API Security in Action, Learning GraphQL, OpenAPI), takes you systematically through 9 phases: Phase 1 covers Scalability, Databases, Caching & Networking. Phase 2 dives into Distributed Systems theory (CAP theorem, Raft consensus, Sagapattern). Phase 3 covers Building Blocks (Kafka, API Gateways, Microservices). Phase 4 covers Architecture (CQRS, Event Sourcing, Security, Observability, CI/CD). Phase 5 tackles end-to-end real-world designs (URL Shortener, Chat System, News Feed, Video Platform). Phase 6 covers Advanced Patterns (Strangler Fig, Event-Driven Microservices, Micro-Frontends). Phase 7 covers Trade-Off Analysis & the C4 Model. Phase 8 delivers advanced designs (Proximity Services/Quadtrees, Metrics TSDBs, Apache Kafka Deep Dive, Load Balancers, CDNs). Phase 9 focuses on robust API Architecture & Integration (REST modeling, OpenAPI contracts, GraphQL scaling, OAuth/JWT Security, Webhooks, and API Lifecycles). Concludes with the ultimate System Design Interview Framework.",
        tags: ["DDIA", "Distributed Systems", "Kafka", "REST API", "GraphQL", "OpenAPI", "CQRS", "C4 Model", "Microservices", "Raft"],
    },
    {
        repo: "DDD",
