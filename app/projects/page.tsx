...
const githubProjects = [
    ...
    },
    {
        ...
        subtitle: "34 chapters · 8 phases · Scale to Millions",
        description:
            "How do you design YouTube? How does WhatsApp deliver a message in 30 ms? This 34-chapter curriculum, distilled from over 30 professional-grade textbooks (DDIA by Kleppmann, Alex Xu's System Design Interview Vol. 1 & 2, ByteByteGo Big Archive, AlgoMaster Handbook, The C4 Model), takes you systematically through 8 phases: Phase 1 covers Scalability, Databases, Caching & Networking. Phase 2 dives into Distributed Systems theory — CAP theorem, Raft consensus, Saga pattern, and partitioning. Phase 3 covers the Building Blocks: Kafka, API Gateways, Microservices & Data Pipelines. Phase 4 covers Architecture — CQRS, Event Sourcing, Security, Observability & CI/CD. Phase 5 tackles end-to-end real-world designs (URL Shortener, Chat System, News Feed, Video Platform). Phase 6 covers Advanced Patterns: Strangler Fig, Event-Driven Microservices, and Micro-Frontends. Phase 7 covers Trade-Off Analysis, Evolutionary Architectures & the C4 Model. Phase 8 delivers advanced designs: Proximity Services (Quadtrees/Geohashes), Metrics Monitoring, Distributed Message Queue, Apache Kafka Deep Dive, Load Balancers, CDNs, and the ultimate System Design Interview Framework.",
        tags: ["DDIA", "Distributed Systems", "Kafka", "Redis", "CQRS", "Saga Pattern", "C4 Model", "CDN", "Microservices", "Raft"],
    },
    {
        repo: "DDD",
