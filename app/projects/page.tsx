...
const githubProjects = [
    {
        ...
        subtitle: "Alfred · Bilingual (EN/ES) · Multi-account Gmail, Drive & Photos · Native WA Bridge · Atomic Session Reset · Android Auto",
        description:
            "\"At your service, sir!\" A production-ready, full-stack AI butler that securely connects to multiple Google Accounts via OAuth 2.0 to manage your Gmail, Drive, Photos, Calendar, and Maps concurrently — and now connects natively to your WhatsApp via a custom Dockerized bridge (Baileys), with no Meta API tokens required. Simply scan a QR code in the high-fidelity dark-mode dashboard (mirroring WhatsApp Web) to link your personal account. Recently updated with a \"nuclear\" atomic session reset to purge stale connections instantly. The AI assistant is fully bilingual (English and Spanish), capable of aggregating and searching across multiple Gmail inboxes and Drive accounts, sending WhatsApp messages on your behalf, deleting calendar events, and automatically generating Android Auto navigation links for any address in your schedule. Powered by OpenAI for intelligent intent parsing, it features custom email reply templates, geocoding via Google Maps, and AES-encrypted token storage at rest. Includes a streamlined dashboard with 1-click links to enable and configure the required Google APIs effortlessly. Get started in 5 commands: git clone → ./build.sh → scan QR → Alfred is live at localhost:5173. Fully containerized: Spring Boot 3.4 + React 18 + Node.js Bridge + PostgreSQL 16.",
        tags: ["Spring Boot 3.4", "React 18", "Bilingual", "Multi-account Gmail", "Native WA Bridge", "Socket.io", "OpenAI", "QR Authentication", "Android Auto", "Google OAuth2", "Gmail API", "Drive API", "Photos API", "Calendar API", "Maps API", "PostgreSQL 16", "Docker"],
    },
    {
        repo: "test-with-llms",
    ...
    },
    {
        ...
        subtitle: "15 chapters · Visual Guides · Java, Python & C++",
        description:
            "A comprehensive collection of 15 algorithm chapters with visual explanations, step-by-step diagrams, and complete implementations in Java, Python, and C++. Built from insights across classic computer science texts including Introduction to Algorithms (CLRS), Grokking Algorithms, The Algorithm Design Manual, and Cracking the Coding Interview. Covers Binary Search, Selection Sort, Merge Sort, Quicksort, BFS, Dijkstra's Algorithm, Dynamic Programming, Hash Tables, DFS, Hungarian Algorithm, Greedy Algorithms, Heapsort, Topological Sort, K-Nearest Neighbors (KNN), and A* Search — each with realistic hero images, execution diagrams, and tri-language code.",
        tags: ["Algorithms", "Data Structures", "Java", "Python", "C++", "Graph Algorithms", "Dynamic Programming", "Sorting", "Pathfinding", "Machine Learning"],
    },
    {
        repo: "Cplusplus",
    ...
    },
    {
        ...
        subtitle: "58 chapters · 13 phases · Scale to Millions",
        description:
            "How do you design YouTube? How does WhatsApp deliver a message in 30 ms? This 58-chapter curriculum, distilled from over 48 professional-grade textbooks (DDIA, Alex Xu's Volumes, API Security in Action, Learning Serverless, Serverless Architectures on AWS, Model Context Protocol), takes you systematically through 13 phases: Phase 1 covers Scalability, Databases, Caching & Networking. Phase 2 dives into Distributed Systems theory (CAP, Raft, Saga). Phase 3 covers Building Blocks (Kafka, Gateways, Microservices). Phase 4 covers Architecture (CQRS, Event Sourcing, Observability, CI/CD). Phase 5 tackles end-to-end designs (URL Shortener, Chat, News Feed, Video). Phase 6 covers Advanced Patterns (Strangler Fig, Micro-Frontends). Phase 7 covers Trade-Offs & the C4 Model. Phase 8 delivers advanced designs (Proximity/Quadtrees, TSDBs, Kafka Deep Dive). Phase 9 focuses on robust API Architecture (REST, OpenAPI, GraphQL, OAuth/JWT). Phase 10 introduces Serverless Architecture & Cloud-Native Patterns. Phase 11 tackles Data-Intensive Systems & Flow Architectures. Phase 12 covers API Ecosystems & Professional Practice. Phase 13 covers Model Context Protocol (MCP) & AI Agent Architectures. Concludes with the ultimate System Design Interview Framework.",
        tags: ["DDIA", "Distributed Systems", "Serverless", "AWS", "Kafka", "REST API", "GraphQL", "CQRS", "C4 Model", "Microservices", "MCP", "AI Agents"],
    },
    {
        repo: "DDD",
