...
<div align="center" className="my-6">
  <span className="inline-block px-5 py-2.5 bg-slate-800/50 text-indigo-300 font-mono rounded-lg border border-indigo-500/10 text-base sm:text-lg">
    Target &larr; Prerequisites : Recipe Commands
  </span>
</div>
...
<table>
  ...
  <tbody>
    ...
    <tr>
      ...
      <td align="left">Construction Foreman</td>
      <td align="left">Timestamp checking & target rule recipes</td>
      <td align="left">Automates multi-file builds cleanly</td>
    </tr>
    <tr>
